...
public class ContactosService {
	private final String DIR="c:\\temp\\contactos.txt";
	...
	public Contacto buscarContacto(Integer numero) {
		...
		try(FileReader fr = new FileReader(DIR);
                ...
                while(dato!=null) {                  
                    ...
                    //comprobamos si el primer elemento del array, que es el número
	...
	public void eliminarContacto(Integer numero) {
		...
		try (FileOutputStream fos=new FileOutputStream(DIR, false);
                PrintStream out=new PrintStream(fos);){
